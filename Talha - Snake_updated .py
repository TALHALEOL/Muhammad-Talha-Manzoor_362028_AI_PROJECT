# -*- coding: utf-8 -*-
"""
Created on Mon Jan  1 18:54:36 2024
...
class AISnake:
    ...
    def check_collision(self, obstacle_coords):
        ...
        if x < 0 or x >= WIDTH or y < 0 or y >= HEIGHT:
            ...
            self.game.on_ai_snake_died("The End")
...
class SnakeGame:
    ...
    def create_food(self):
        ...
        while y in obstacles_y:
            y = random.randint(0, self.max_y()) * 20
        food = self.canvas.create_rectangle(x, y, x + 20, y + 20, fill="white", tags="food")
        return food
    ...
    def check_collision(self):
        ...
        if x < 0 or x >= WIDTH or y < 0 or y >= HEIGHT:
            # Game over condition (you can implement game over logic here)
            self.on_snake_died("The End!")

        # Snake colliding with a obstacle
        for obstacle in self.obstacles:
            self.is_collided(obstacle, "The End!")
